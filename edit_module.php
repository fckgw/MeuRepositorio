...
if (
    ...
    !empty(trim($_POST['module_name'])) &&
    !empty(trim($_POST['module_path']))
) {
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['admin_message'] = "Erro ao atualizar o módulo: " . $stmt->error;
        $_SESSION['admin_status'] = 'error';
    }
} else {
    $_SESSION['admin_message'] = "Dados inválidos. Todos os campos são obrigatórios.";
    $_SESSION['admin_status'] = 'error';
}
